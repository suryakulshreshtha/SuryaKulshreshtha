...
### 🏷️
![CI](https://img.shields.io/github/actions/workflow/status/suryakulshreshtha/ForkableInterviewToolkit/ci.yml?label=CI&logo=github)
![Python](https://img.shields.io/badge/Python-3.11-blue?logo=python)
![Playwright](https://img.shields.io/badge/Playwright-Automation-green?logo=microsoft)
![Pytest](https://img.shields.io/badge/Pytest-Framework-orange?logo=pytest)
![License](https://img.shields.io/github/license/suryakulshreshtha/ForkableInterviewToolkit?logo=open-source-initiative)


**[Forkable Playwright Self-Healer](https://github.com/suryakulshreshtha/ForkablePlaywrightSelfHealer)** Self-healing Playwright tests driven by plain English. The same spec passes before and after a UI refactor that deletes every `data-testid` and renames every id — locators re-bind at run time and the repair is remembered. Heuristic-first with an optional local LLM (Ollama + RAG), runs fully offline, 125 tests.

**[Playwright Python Pytest Framework](https://github.com/suryakulshreshtha/ForkablePythonProjectShowcase)** End-to-end test automation framework — UI + API testing, network mocking, Page Object Model, data-driven tests, Docker, and GitHub Actions CI. Built with Playwright, Python, and Pytest.
...
**[Python Playwright Learning](https://github.com/suryakulshreshtha/Forkable04EyePythonPlaywrightLearning)** Learning project for Playwright automation with Python, focused on E2E testing workflows. Sample tests, GitHub Actions CI, and a playground for practicing automation.
...
**[Python Playwright Interview Notes](https://github.com/suryakulshreshtha/ForkableInterviewToolkit)** Explore ForkableInterviewToolkit (github.com in Bing) — runnable Python + Playwright interview prep that turns every answer into executable proof. Direct Answer → Real-Time Example → Code → STAR Answer → Interview-Ready Answer → Interview Tip → One-Line Revision
...
This stencil makes it clear: **same setup, different repo**. Users just swap `<REPO_URL>` and `<PROJECT_PATH>` depending on which Forkable project they want to explore.  

Run it yourself:
```bash
git clone https://github.com/suryakulshreshtha/<Name Of Git>.git
cd <Run Path>
